...
class gsp_survey_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(13)
expressionOut.print(createLinkTo(dir:'images/BS',file:'HEADER.png'))
printHtmlPart(14)
invokeTag('select','g',44,['from':(['en', 'es']),'name':("lang"),'value':(session.locale),'noSelection':(session.locale)],-1)
printHtmlPart(15)
expressionOut.print(createLink(uri: '/'))
printHtmlPart(16)
expressionOut.print(createLink(controller:'View_SurveyManifiesto', action:'index'))
printHtmlPart(17)
expressionOut.print(createLink(controller:'Acompan', action:'index'))
printHtmlPart(18)
expressionOut.print(createLink(controller:'CatRecreativeActivity', action:'index'))
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1398113556502L
