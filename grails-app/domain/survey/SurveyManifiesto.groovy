...
class SurveyManifiesto {
    ...
    String          acompaniantes           // arreglo csv de ids Tabla Acompan: Hijos, nietos, amigos, parientes, select multiple
    String          otroAcompan             // capturado en el momento, otro tipo acompaniante
    Integer         numAcompan              // numero de acompañantes
