	...
	<body>
                                        ...
                                        <g:form action="buscar">
                                         <table class="table table-bordered" style="width: auto;"> 
                                                        ...
                                                        <th style="background-color: #EEE;" colspan="6">
                                                                                <strong>${message(code: 'view_SurveyManifiesto.filtros.label', default: 'Aplicar Filtros')}</strong>                                                                            
                                                                                <!--<g:submitToRemote update="list-view_SurveyManifiesto" url="[action:'buscar']" value="Buscar"/>-->
                                                                                <g:actionSubmit class="btns pull-right btns-search" value="${message(code: 'view_SurveyManifiesto.search.label', default: 'Search')}" action="buscar"/>
                                                        </th>   
                                                        </thead>   
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <label><g:message code="view_SurveyManifiesto.id.label" default="ID Manifiesto" /></label>
                                                                    <input type="text" name="idmanifiesto" value="${session.idmanifiesto}">
                                                                </td>   
                                                                <td>
                                                                    <label><g:message code="view_SurveyManifiesto.nombrepareja.label" default="Nombre Pareja" /></label>
                                                                    <input type="text" name="nombrepareja"  value="${session.nombrepareja}">
                                                                </td>
                                                                <td>
                                                                    <label><g:message code="view_SurveyManifiesto.numeropareja.label" default="Número Pareja" /></label>
                                                                    <input type="text" name="numero" value="${session.numeropareja}">
                                                                </td>
                                                           </tr>
                                                           <tr>
                                                                  <td>
                                                                    <label><g:message code="view_SurveyManifiesto.fechamanifiesto.label" default="Fecha Manifiesto" /></label>
                                                                    <input type="text" id="fechaman" name="fechaman" value="${session.fechamanifiesto}">
                                                                  </td>
                                                                  <td>
                                                                    <label><g:message code="view_SurveyManifiesto.hospedado.label" default="Hotel" /></label>
                                                                    <input type="text" name="hotel" value="${session.hotel}">
                                                                  </td>
                                                                  <td>
                                                                    <label><g:message code="view_SurveyManifiesto.numeroconfirmacion.label" default="Num. Confirmación" /></label>
		...
		<div id="list-view_SurveyManifiesto" class="content scaffold-list" role="main">
			...
			<table class="table table-bordered">
						...
						<g:sortableColumn property="fechamanifiesto" title="${message(code: 'view_SurveyManifiesto.fechamanifiesto.label', default: 'Fecha Manifiesto')}" />
