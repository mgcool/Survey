...
<html>
	...
	<body>
		...
		<div id="show-secFlujo" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:secFlujoInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${secFlujoInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
