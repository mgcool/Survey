		...
		<div id="list-surveyManifiesto" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="idmanifiesto" title="${message(code: 'surveyManifiesto.idmanifiesto.label', default: 'idmanifiesto')}" />
				...
				<g:each in="${surveyManifiestoInstanceList}" status="i" var="surveyManifiestoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${surveyManifiestoInstance.id}">${fieldValue(bean: surveyManifiestoInstance, field: "idmanifiesto")}</g:link></td>
