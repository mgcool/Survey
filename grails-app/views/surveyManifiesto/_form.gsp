                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="fieldcontain ${hasErrors(bean: surveyManifiestoInstance, field: 'idacompan', 'error')} required">
                                                                            ...
                                                                            <g:select multiple="multiple" id="idacompan" name="idacompan" from="${survey.Acompan.list()}" optionKey="id" required="" value="${surveyManifiestoInstance?.idacompan}" class="many-to-one"/>
