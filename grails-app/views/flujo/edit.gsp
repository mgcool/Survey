...
<html>
	...
	<body>
		...
		<div id="edit-flujo" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${flujoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${flujoInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:flujoInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${flujoInstance?.version}" />
				<fieldset class="form">
